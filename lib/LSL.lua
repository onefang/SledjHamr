...
local constants =
{
  ...
  newConst("integer", "PSYS_PART_INTERP_COLOR_MASK",	1),
  newConst("integer", "PSYS_PART_INTERP_SCALE_MASK",	2),
  newConst("integer", "PSYS_PART_BOUNCE_MASK",		4),
  newConst("integer", "PSYS_PART_WIND_MASK",		8),
  newConst("integer", "PSYS_PART_FOLLOW_SRC_MASK",	16),
  newConst("integer", "PSYS_PART_FOLLOW_VELOCITY_MASK",	32),
  newConst("integer", "PSYS_PART_TARGET_POS_MASK",	64),
  newConst("integer", "PSYS_PART_TARGET_LINEAR_MASK",	128),
  newConst("integer", "PSYS_PART_EMISSIVE_MASK",	256),

  newConst("integer", "PSYS_SRC_PATTERN_DROP",			1),
  newConst("integer", "PSYS_SRC_PATTERN_EXPLODE",		2),
  newConst("integer", "PSYS_SRC_PATTERN_ANGLE",			4),
  newConst("integer", "PSYS_SRC_PATTERN_ANGLE_CONE",		8),
  newConst("integer", "PSYS_SRC_PATTERN_ANGLE_CONE_EMPTY",	16),
